            ...
            <AnimatePresence>
                {mobileMenuOpen && (
                    <motion.div
                        ...
                        className="absolute top-[calc(64px+16px+8px)] sm:top-[calc(72px+24px+8px)] left-4 right-4 sm:left-6 sm:right-6 z-50 bg-white/95 backdrop-blur-md border border-black/5 rounded-[20px] px-4 py-4 shadow-2xl lg:hidden pointer-events-auto"
                    >
